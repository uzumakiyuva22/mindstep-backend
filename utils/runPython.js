...
module.exports = function runPython(code, stdin = "") {
  return new Promise((resolve) => {
    ...
    const child = spawn(command, [filepath], { windowsHide: true });

    let stdout = "";
    let stderr = "";
    let timedOut = false;
    const timeoutMs = Number(process.env.PY_EXEC_TIMEOUT_MS || 8000);
